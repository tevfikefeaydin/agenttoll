...
`get_market_brief`, `get_new_token_radar`, `get_fresh_pools`, `scout_new_tokens`, `get_try_premium`, `get_try_spread`, `get_base_portfolio`,
`check_token_safety`,
`get_radar_scorecard`, `get_radar_history`,
